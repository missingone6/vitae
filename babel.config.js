  ...
  plugins: [
    ...
    [
      'babel-plugin-react-css-modules',
      {
        ...
        webpackHotModuleReloading: true,//在 webpack 中启用 CSS 热重载
        generateScopedName: '[name]__[local]__[hash:base64:5]',//默认值
        autoResolveMultipleImports: true,//如果styleName仅在其中之一中，则允许多个匿名导入。
      }
    ],
  ],
};